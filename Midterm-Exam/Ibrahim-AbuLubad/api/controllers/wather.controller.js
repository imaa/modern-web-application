...
const getAll = (req, res) => {
    ...
    Weather.find(query).skip(req.query.skip >= 0 ? numbers.getInt(req.query.skip) : 0)
        .limit(req.query.limit > 0 && req.query.limit <= configs.api.weather.maxListLimit()
            ? numbers.getInt(req.query.limit) : configs.api.weather.defaultListLimit())
        .exec((err, data) => {
